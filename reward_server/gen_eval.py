...
DEVICE = "cpu"
MY_CONFIG_PATH="mmdetection2/configs/mask2former/mask2former_swin-s-p4-w7-224_lsj_8x2_50e_coco.py"
MY_CKPT_PATH="model/mask2former2/mask2former_swin-s-p4-w7-224_lsj_8x2_50e_coco.pth"
...
def load_geneval():
    ...
    def load_models():
        ...
        CONFIG_PATH = (BASE_DIR / MY_CONFIG_PATH).resolve()
        CKPT_PATH   = (BASE_DIR / MY_CKPT_PATH).resolve() 
